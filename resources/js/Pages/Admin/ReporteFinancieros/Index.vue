...
const { setReporteFinanciero, limpiarReporteFinanciero } =
...
const accionesRow = () => {
    // editar
    $("#table-reporte_financiero").on("click", "button.editar", function (e) {
        e.preventDefault();
        let id = $(this).attr("data-id");
        axios.get(route("reporte_financieros.show", id)).then((response) => {
    ...
    // eliminar
    $("#table-reporte_financiero").on("click", "button.eliminar", function (e) {
        e.preventDefault();
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let respuesta = await axiosDelete(
                    route("reporte_financieros.destroy", id)
                );
...
<template>
    ...
    <!-- END breadcrumb -->
    <!-- BEGIN page-header -->
    <h1 class="page-header">Reporte Financiero</h1>
    <!-- END page-header -->
